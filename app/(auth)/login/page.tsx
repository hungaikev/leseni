/**
 * Login Page with Magic Code Authentication
 */
      ...
      >
        <Card className="border-2 shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-3xl font-bold">Welcome to Leseni</CardTitle>
            <CardDescription>
              {step === "email"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">New to Leseni?</span>
              </div>
            </div>
